...
@implementation NSString (DES_AES)

- (NSString *)encryptStringWithKey:(NSString *)keyString iv:(NSData *)iv {
...
- (NSString *)decryptStringWithKey:(NSString *)keyString iv:(NSData *)iv {
    // 设置秘钥
    NSData *keyData = [keyString dataUsingEncoding:NSUTF8StringEncoding];
    uint8_t cKey[kCCKeySizeDES];
    bzero(cKey, sizeof(cKey));
